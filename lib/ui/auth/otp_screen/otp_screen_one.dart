...
class OTPScreenOne extends StatelessWidget {
  ...
  const OTPScreenOne({Key? key, required this.bodyParams}) : super(key: key);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('OTP Verification'.tr, style: const TextStyle(color: Colors.white, fontSize: 26, fontWeight: FontWeight.w600)),
                      Text('You get OTP from your email.'.tr, style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w400)),
                      const SizedBox(
                        height: 50,
                      ),
                      OTPTextField(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Padding(
                            ...
                            child: Text('Register now'.tr, style: const TextStyle(fontWeight: FontWeight.w600)),
                          ),
                        ),
                      ),
                    ],
