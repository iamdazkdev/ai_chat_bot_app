...
class TextToImageScreenOne extends StatelessWidget {
  const TextToImageScreenOne({Key? key}) : super(key: key);
    ...
    return GetX<TextToImageController>(
        ...
        builder: (controller) {
          return Scaffold(
            ...
            appBar: AppBar(title: Text('CheaperBot Image'.tr), actions: [
              InkWell(
                onTap: () {
                  showDialog(
                        ...
                        children: [
                          ...
                          InkWell(
                              ...
                              child: Text("Subscribe Now".tr,
                                  style:
                                      TextStyle(color: ConstantColors.blue04))),
                        ],
                      ),
                    ),
                  ),
