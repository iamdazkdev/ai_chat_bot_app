...
class AiCodeScreenTwo extends StatelessWidget {
  const AiCodeScreenTwo({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetX<AiCodeController>(
        ...
        builder: (controller) {
          return Scaffold(
            appBar: AppBar(title: Text('AI Code'.tr), backgroundColor: ConstantColors.grey01, centerTitle: false),
            body: Container(
              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      Visibility(
                        visible: Constant().isAdsShow() && controller.bannerAd != null,
                        child: Center(
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintMaxLines: 3,
                          hintText: 'Enter the details about code you want generate here'.tr,
                          hintStyle: TextStyle(color: ConstantColors.hintTextColor, fontSize: 16),
                          contentPadding: const EdgeInsets.only(left: 10, right: 10, top: 10, bottom: 10),
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(color: ConstantColors.cardViewColor),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color: controller.isSelected.value == false ? Colors.grey : ConstantColors.blue04, shape: BoxShape.rectangle, borderRadius: const BorderRadius.all(Radius.circular(30))),
                          child: Padding(
                      ...
                      Visibility(visible: controller.answer.isNotEmpty, child: chatBubble(context)),
                      const SizedBox(
                        height: 5,
                      ),
                      Visibility(
  ...
  chatBubble(BuildContext context) {
    return GetBuilder<AiCodeController>(builder: (controller) {
      return Column(
        children: [
          Row(
              ...
              GestureDetector(
                ...
                child: Padding(
                  ...
                  child: controller.textToSpeechQuesion.value == true
                    ...
                    child: const Icon(Icons.volume_up_outlined, color: Colors.grey, size: 16),
                  ),
                ),
              ),
              Flexible(
                child: Container(
                  ...
                  decoration:
                  BoxDecoration(color: ConstantColors.blue04, borderRadius: const BorderRadius.only(topRight: Radius.circular(10), topLeft: Radius.circular(10), bottomLeft: Radius.circular(10))),
                  child: Column(
              ...
              children: [
                ...
                Flexible(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: ConstantColors.grey01, borderRadius: const BorderRadius.only(topRight: Radius.circular(10), topLeft: Radius.circular(10), bottomRight: Radius.circular(10))),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
