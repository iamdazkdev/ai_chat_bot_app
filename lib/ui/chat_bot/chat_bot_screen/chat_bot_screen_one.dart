...
class ChatBotScreenOne extends StatefulWidget {
  const ChatBotScreenOne({Key? key}) : super(key: key);

  @override
  State<ChatBotScreenOne> createState() => _ChatBotScreenState();
}

class _ChatBotScreenState extends State<ChatBotScreenOne> {
  @override
    ...
    return GetX<ChatBotController>(
      ...
      builder: (controller) {
        return Scaffold(
          ...
          appBar: AppBar(title: Text('CheaperBot'.tr), actions: [
            InkWell(
              onTap: () {
                showDialog(
                ...
                children: [
                  ...
                  InkWell(
                      ...
                      child: Text('Subscribe Now'.tr,
                          style: TextStyle(color: ConstantColors.blue04))),
                ],
              ),
            ),
          ),
