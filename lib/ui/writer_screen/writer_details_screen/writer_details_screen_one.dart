...
class WriterDetailsScreenOne extends StatelessWidget {
  const WriterDetailsScreenOne({Key? key}) : super(key: key);
    ...
    return GetX<WriterDetailsController>(
        ...
        builder: (controller) {
          return Scaffold(
            ...
            appBar: AppBar(title: Text(controller.categoryData.value.name!.tr), centerTitle: true),
            body: Padding(
