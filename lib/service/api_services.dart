...
class ApiServices {
  // API
  static const baseUrlOfAPI = "https://chat.trendi.ai/";
  static const apiKey = "base64:4AIwgwpA1hEyEODko/AKfQhbmI+sIu1QCKkN+S4JiFU=";
  ...
  static const deleteChatHistory = "${baseUrlOfAPI}api/v1/delete-chat-history";
  ...
  static const referCode = "${baseUrlOfAPI}api/v1/refercode";
  static const socialLogin = "${baseUrlOfAPI}api/v1/social-login";
  static const deletePromsHistory =
      "${baseUrlOfAPI}api/v1/delete-proms-history";

  //statistics Feature
  //Word count post to the server
  static const chatWordCountPostUrl = "${baseUrlOfAPI}api/v1/chat-statistics";
  static const promsCountPostUrl = "${baseUrlOfAPI}api/v1/proms-statistics";
  static const imageCountPostUrl = "${baseUrlOfAPI}api/v1/image-statistics";
  static const getAllstatistics = "${baseUrlOfAPI}api/v1/get-statistics";
