...
class SettingData {
  ...
  SettingData.fromJson(Map<String, dynamic> json) {
    ...
    modelType = json['model_type'] ?? "gpt-4";
    ...
    app_homepage_theme = json['app_homepage_theme'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['app_homepage_theme'] = app_homepage_theme;
    return data;
  }
}
