  ...
  Future<SettingModel?> getSettingsData() async {
    try {
      ...
      if (response.statusCode == 200 && responseBody['success'] == "Success") {
        ...
        Constant.publicAppSpecificAPIKeysOfAndroid = model.data!.apikeyAndroidRevenuecat;
        Constant.publicAppSpecificAPIKeysOfIos = model.data!.apikeyIosRevenuecat;
        Constant.modelType = model.data!.modelType;

        Constant.theme = model.data!.app_homepage_theme;
        // Constant.isAdsEnabled =
        //     model.data!.addIsEnabled == "yes" ? true : false;
        Constant.isAdsEnabled = false;
        ...
        Constant.rewardIosKey = model.data!.androidRewardAdsId; //"ca-app-pub-3940256099942544/1712485313";
        Constant.rewardAndroidAdsKey = model.data!.iosRewardAdsId; //"ca-app-pub-3940256099942544/5224354917";
